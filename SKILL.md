...
- **La copia descargada del repo se queda** (ya sin `.git`): su `.env` es el que el usuario ve en su panel de Archivos, y ahí es donde va a pegar. No importa en cuál copia pegue: `set-keys` busca en todas y las limpia todas.
